...
return [
    ...
    "reopen"                           => "Reabrir",
    "reopen_sale"                      => "Reabrir esta venda no registrador para editar itens, preços e descontos.",
    ...
    "item_not_found"                    => "Produto não cadastrado no sistema.",
    ...
    "unsuccessfully_reopened_sale"     => "Falha ao reabrir a venda.",
