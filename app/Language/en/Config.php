...
return [
    ...
    "simple_mode"                               => "Sale mode",
    "simple_mode_conf"                          => "Register sale mode",
    "simple_mode_label"                         => "Simple Mode",
    "simple_mode_help"                          => "Turns on the short register flow with help pointers, for someone who is just learning. When off, the register behaves exactly as it does today. This setting belongs to your user only: everyone at the register has their own mode.",
