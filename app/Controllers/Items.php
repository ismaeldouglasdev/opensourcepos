...
class Items extends Secure_Controller
{
    ...
    public function postRotateItemImage(int $item_id): void
    {
        ...
        $saved = match ($out_ext) {
            'png'  => imagepng($rotated, $image_path, 9),
            'gif'  => imagegif($rotated, $image_path),
            'webp' => imagewebp($rotated, $image_path, 90),
            default => imagejpeg($rotated, $image_path, 90),
        };
        ...
        // Group-writable so the inventory-service write-back can overwrite later
